...
class Maplet_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Maplet_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Maplet_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/maplet-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/maplet-admin.js', array( 'jquery' ), $this->version, false );
 ...
 */
	...
	public function add_plugin_admin_menu() {
	     ...
	     *
	     */
	    add_options_page( 'Maplet options', 'Maplet', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page')
	    );
	}
